...
Dowiązania KDE/Qt dla języków innych niż C++.
...
Summary(pl.UTF-8):   Dowiązania języka C dla DCOP
...
Dowiązania języka C dla DCOP.

%package dcop-c-devel
Summary:	kdebindings-dcop-c header files
Summary(pl.UTF-8):   Pliki nagłówkowe dla kdebindings-dcop-c
Group:		X11/Development/Libraries
...
Pliki nagłówkowe dla kdebindings-dcop-c.

#%if %{?_with_java:1}%{!?_with_java:0}
#%package dcop-java
#Summary:	Java bindings for DCOP
#Summary(pl):	Dowiązania języka Java dla DCOP
#Group:		X11/Development/Libraries
#Requires:	jdk
#Requires:	kdelibs >= %{version}
#Requires:	qt >= 3.1
...
#Dowiązania języka Java dla DCOP.
#%endif

#%package dcop-perl
#Summary:	Perl bindings for DCOP
#Summary(pl):	Dowiązania języka Perl dla DCOP
#Group:		X11/Development/Libraries
...
#Dowiązania języka Perl dla DCOP.

#%package dcop-python
#Summary:	Python bindings for DCOP
#Summary(pl):	Dowiązania języka Python dla DCOP
#Group:		X11/Development/Libraries
...
#Dowiązania języka Python dla DCOP.

#%package kalyptus
#Summary:	QT/KDE bindings generator
#Summary(pl):	Generator dowiązań do QT/KDE
#Group:		X11/Development/Libraries
#Requires:	perl >= 5.6.1
#Requires:	kdelibs >= %{version}
#Requires:	qt >= 3.1
...
#Kalyptus służy do generowania dowiązań do QT/KDE bezpośrednio
#z plików nagłówkowych.

%package kde-c
Summary:	C bindings for KDE
Summary(pl.UTF-8):   Dowiązania języka C dla KDE
Group:		X11/Development/Libraries
Requires:	libgcc
...
Summary(pl.UTF-8):   Pliki nagłówkowe dla kdebindings-kde-java
Group:		X11/Development/Libraries
...
Pliki nagłówkowe dla kdebindings-kde-java.
%endif

%package kjsembed
Summary:	A library for embedding the KJS Javascript interpreter
Summary(pl.UTF-8):   Biblioteka pozwalająca na zagnieżdżanie intepretera KJS
Group:		X11/Development/Libraries
Requires:	kdelibs >= %{version}
...
Biblioteka pozwalająca na zagnieżdżanie intepretera javascript - KJS,
...
Kpart umożliwiający używanie mozilli jako silnika przeglądarki
zamiast khtml.
%endif

#%package kde-objc
#Summary:	ObjC bindings for KDE
#Summary(pl):	Dowiązania języka ObjC dla KDE
#Group:		X11/Development/Libraries
...
#Dowiązania języka ObjC dla KDE.

%package qt-c
Summary:	C bindings for Qt
Summary(pl.UTF-8):   Dowiązania języka C dla Qt
Group:		X11/Development/Libraries
Requires:	libgcc
Requires:	qt >= 3.1
...
Summary(pl.UTF-8):   Pliki nagłówkowe dla kdebindings-qt-java
Group:		X11/Development/Libraries
Requires:	%{name}-qt-java = %{version}
...
Pliki nagłówkowe dla kdebindings-qt-java.
%endif

#%package qt-objc
#Summary:	ObjC bindings for Qt
#Summary(pl):	Dowiązania języka ObjC dla Qt
#Group:		X11/Development/Libraries
#Requires:	libobjc
#Requires:	qt >= 3.1
...
Summary(pl.UTF-8):   Pliki nagłówkowe dla kdebindings-smoke-qt
Group:		X11/Development/Libraries
...
Pliki nagłówkowe dla kdebindings-smoke-qt.
...
Summary(pl.UTF-8):   Pliki nagłówkowe dla kdebindings-xparts-gtk
Group:		X11/Development/Libraries
...
Pliki nagłówkowe dla kdebindings-xparts-gtk.
...
Summary(pl.UTF-8):   Pliki nagłówkowe dla kdebindings-xparts-interfaces
Group:		X11/Development/Libraries
...
Pliki nagłówkowe dla kdebindings-xparts-interfaces.
...
Technologia XParts: zagnieżdżanie KDE.
